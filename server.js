...
const pairingchallenges = require('./games/pairing.js')
const typingChallenges = require('./games/typing.js')
const debuggingChallenges = require('./games/debugging.js')
const sortingChallenges = require('./games/sorting.js')
const invalidChallenges = require('./games/valid.js')
const queryingChallenges = require('./games/querying.js')
const cssChallenges = require('./games/levels.js')
const app = express()
